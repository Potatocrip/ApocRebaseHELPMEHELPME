...
/datum/asset/changelog_item/New(date)
	...
	SSassets.transport.register_asset("apoc_[item_filename]", file("html/changelogs/apoc_archive/" + item_filename)) // APOC EDIT CHANGE - SPLIT_CHANGELOG

/datum/asset/changelog_item/send(client)
	if (!item_filename)
		return

	. = SSassets.transport.send_assets(client, list(item_filename, "darkpack_[item_filename]", "apoc_[item_filename]")) // DARKPACK EDIT CHANGE - SPLIT_CHANGELOG // APOC EDIT CHANGE - SPLIT_CHANGELOG
...
/datum/asset/changelog_item/get_url_mappings()
	...
	. += list("apoc_[item_filename]" = SSassets.transport.get_asset_url("apoc_[item_filename]")) // APOC EDIT ADD - SPLIT_CHANGELOG
...
/datum/asset/changelog_item/unregister()
	...
	SSassets.transport.unregister_asset("apoc_[item_filename]") // APOC EDIT ADD - SPLIT_CHANGELOGG
