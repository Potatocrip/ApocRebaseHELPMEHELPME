...
export async function processAutoChangelog({ github, context }) {
  ...
  github.rest.repos.createOrUpdateFileContents({
    ...
    path: `html/changelogs/AutoChangeLog-apoc-pr-${context.payload.pull_request.number}.yml`, // DARKPACK EDIT CHANGE - SPLIT_CHANGELOG // APOC EDIT CHANGE - SPLIT_CHANGELOG
